...
<head>
  ...
  <meta name="author" content="Chijindu Nwokeohuru, biz.forahia@gmail.com, chijindu.nwokeohuru@gmail.com">
  <meta name="description" content="iLearn LMS offers industry-specific courses, simplifying enrollment and enhancing learner retention.">
...
<body class="td_theme_2">
          ...
          <div class="td_top_header_left">
            <ul class="td_header_contact_list td_mp_0 td_normal">
              ...
              <li>
                ...
                <span>
                    {{ __('translate.Email') }}: <a href="mailto:{{ $footer->email }}">{{ $footer->email }}</a>
                </span>
              </li>
            </ul>
          </div>
        ...
        <div class="td_main_header_in">
          ...
          <div class="td_main_header_right">
            ...
            <div class="td_hero_icon_btns position-relative">
              ...
              <a class="td_circle_btn td_center td_wishlist_btn" href="{{ route('student.wishlist.index') }}">
  ...
  <footer class="td_footer td_style_1 td_color_1">
        <div class="container">
            ...
            <div class="td_footer_col">
                ...
                <div class="td_newsletter td_style_1">
                    <p class="td_mb_20 td_opacity_7">{{ __('Discover a wide range of industry-specific courses designed to enhance your skills and career.') }}</p>
...
<script>
    (function($) {
        ...
        $(document).ready(function () {
            ...
            if (localStorage.getItem('iLearn-cookie') != '1') {
            ...
            $('.cookie_consent_accept_btn').on('click',function() {
                localStorage.setItem('iLearn-cookie','1');
                $('.cookie_consent_modal').addClass('d-none');
            });
