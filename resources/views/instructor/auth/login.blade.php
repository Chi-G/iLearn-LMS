    ...
    <section class="td_page_heading td_center td_bg_filed td_heading_bg text-center td_hobble"
        ...
        <div class="container">
            <div class="td_page_heading_in">
                <h1 class="td_white_color td_fs_48 td_mb_10"> Instructor Login</h1>
                ...
                <div class="col-lg-6">
                    <div class="td_form_card td_style_1 td_radius_10 td_gray_bg_5">
                        <div class="td_form_card_in">
                            <h2 class="td_fs_36 td_mb_20">Instructor Login</h2>
                            <hr>
                            ...
                            <form method="POST" action="{{ route('instructor.login') }}">
                                ...
                                <div class="td_form_card_text_2 td_mb_50">
                                    <div><a href="{{ route('instructor.password.request') }}"
                                ...
                                <p class="td_form_card_text td_fs_20 td_medium td_heading_color mb-0">Don’t Have an
                                    Account? <a href="{{ route('instructor.register') }}">Sign up</a></p>
                            </form>
                        </div>
                    </div>
                </div>
