    ...
    <div class="container">
        ...
        <div class="row td_gap_y_24">
            <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="td_post td_style_1 td_type_1">
                    <a href="blog-details.html" class="td_post_thumb d-block">
                        <img src="{{ asset('frontend/assets/img/home_2/post_1.jpg') }}" alt="">
                        <span class="td_post_label">Learning</span>
                    </a>
                    <div class="td_post_info">
                        <div class="td_post_meta td_fs_14 td_medium td_mb_20">
                            <span><img src="{{ asset('frontend/assets/img/icons/calendar.svg') }}" alt="">Jan 23
                                , 2024</span>
                            <span><img src="{{ asset('frontend/assets/img/icons/user.svg') }}" alt="">Jhon
                                Doe</span>
                        </div>
                        <h2 class="td_post_title td_fs_24 td_medium td_mb_16">
                            <a href="blog-details.html">Tips for Students and Recent Graduates</a>
                        </h2>
                        <p class="td_post_subtitle td_mb_24 td_heading_color td_opacity_7">Far far away, behind
                            the word moun tains, far from the Conso nantia.</p>
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.35s">
                <div class="td_post td_style_1 td_type_1">
                    <a href="blog-details.html" class="td_post_thumb d-block">
                        <img src="{{ asset('frontend/assets/img/home_2/post_2.jpg') }}" alt="">
                        <span class="td_post_label">Remote</span>
                    </a>
                    <div class="td_post_info">
                        <div class="td_post_meta td_fs_14 td_medium td_mb_20">
                            <span><img src="{{ asset('frontend/assets/img/icons/calendar.svg') }}" alt="">Jan 20
                                , 2024</span>
                            <span><img src="{{ asset('frontend/assets/img/icons/user.svg') }}" alt="">Jhon
                                Doe</span>
                        </div>
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="td_post td_style_1 td_type_1">
                    <a href="blog-details.html" class="td_post_thumb d-block">
                        <img src="{{ asset('frontend/assets/img/home_2/post_3.jpg') }}" alt="">
                        <span class="td_post_label">Reading</span>
                    </a>
                    <div class="td_post_info">
                        <div class="td_post_meta td_fs_14 td_medium td_mb_20">
                            <span><img src="{{ asset('frontend/assets/img/icons/calendar.svg') }}" alt="">Jan 18
                                , 2024</span>
                            <span><img src="{{ asset('frontend/assets/img/icons/user.svg') }}" alt="">Jhon
                                Doe</span>
                        </div>
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.35s">
                <div class="td_post td_style_1 td_type_1">
                    ...
                    <div class="td_post_info">
                        <div class="td_post_meta td_fs_14 td_medium td_mb_20">
                            <span><img src="{{ asset('frontend/assets/img/icons/calendar.svg') }}" alt="">Jan
                                18 , 2024</span>
                            <span><img src="{{ asset('frontend/assets/img/icons/user.svg') }}" alt="">Jhon
                                Doe</span>
                        </div>
