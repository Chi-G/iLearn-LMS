        ...
        <div class="row align-items-center td_gap_y_40">
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.4s">
                <div class="td_section_heading td_style_1">
                    ...
                    <h2 class="td_section_title td_fs_36 mb-0">Our expert team is ready to assist you anywhere in
                        the world</h2>
                    <p class="td_section_subtitle td_fs_18 mb-0">Far far away, behind the word mountains, far from
                        the Consonantia, there live the blind texts. Separated they marks grove right</p>
                </div>
                ...
                <div class="td_height_40 td_height_lg_40"></div>
                <a href="contact.html" class="td_btn td_style_1 td_radius_30 td_medium">
