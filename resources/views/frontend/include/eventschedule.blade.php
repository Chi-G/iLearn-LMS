    ...
    <div class="container">
        <div class="td_section_heading td_style_1 td_type_1 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
            <div class="td_section_heading_left">
                <p
                    class="td_section_subtitle_up td_fs_18 td_semibold td_spacing_1 td_mb_10 text-uppercase td_white_color td_opacity_9">
                    <i></i>
                    Event schedule
                    <i></i>
                </p>
                <h2 class="td_section_title td_fs_48 mb-0 td_white_color">Upcoming Event Conference 2024 Host by
                    Eduon</h2>
            </div>
            <div class="td_section_heading_right">
                <p class="td_section_subtitle td_fs_18 mb-0 td_white_color">Far far away, behind the word
                    mountains, far from the Consonantia, there live the blind texts. Separated</p>
            </div>
        </div>
                        ...
                        <div class="td_card_info_in">
                            <div class="td_mb_30">
                                <ul class="td_card_meta td_mp_0 td_medium td_heading_color">
                                    <li>
                                        <svg class="td_accent_color" width="22" height="24" viewBox="0 0 22 24"
                                    ...
                                    <li>
                                        <svg class="td_accent_color" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <path
                                    ...
                                    <li>
                                        ...
                                        <span>Tsc Center, Northern Asia </span>
                                    </li>
                                </ul>
                            </div>
                            <h2 class="td_card_title td_fs_32 td_semibold td_mb_25">
                                <a href="event-details.html">Education, Research and Innovation (ICERI 2024)</a>
                            </h2>
                            <p class="td_fs_18 td_mb_40">Education is a dynamic and evolving field that plays a
                                crucial role in shaping individuals and societies. While there are significant
                                challenges, </p>
                            <a href="#" class="td_btn td_style_1 td_radius_30 td_medium td_with_shadow">
                ...
                <div class="td_card td_style_1 td_type_2 td_white_bg">
                    ...
                    <div class="td_card_info">
                        <div class="td_card_info_in">
                            ...
                            <h2 class="td_card_title td_fs_32 td_semibold td_mb_25">
                                <a href="event-details.html">Innovate 2024: SXSW EDU Conference & Festival</a>
                            </h2>
                            <p class="td_fs_18 td_mb_40">Education is a dynamic and evolving field that plays a
                                crucial role in shaping individuals and societies. While there are significant
                                challenges, </p>
