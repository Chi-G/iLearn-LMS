        ...
        <div class="row td_gap_y_40">
            <div class="col-lg-6">
                <div class="td_image_box td_style_2">
                    <div class="td_image_box_img_1 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.25s">
                        <img src="{{ asset('frontend/assets/img/home_2/about_1.jpg') }}" alt="">
                    </div>
                    <div class="td_image_box_img_2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                        <img src="{{ asset('frontend/assets/img/home_2/about_2.jpg') }}" alt=""
                            class="td_image_box_img_2_thumb">
                        <svg class="td_image_box_img_2_icon td_accent_color" width="130" height="40"
                            viewBox="0 0 130 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_2352_1372" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="130" height="40">
                                <path
                            ...
                            <g mask="url(#mask0_2352_1372)">
                                ...
                                <path
                                    ...
                                    fill="#00001B" />
                                <mask id="mask1_2352_1372" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="50"
                                ...
                                <mask id="mask2_2352_1372" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="15"
                    ...
                    <div class="td_award_box wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.25s">
                        <div class="td_award_box_icon td_center">
                            <img src="{{ asset('frontend/assets/img/home_2/cs_award_box_icon.svg') }}" alt="">
                        </div>
                        <div class="td_award_box_in">
                            <p class="td_fs_24 td_semibold td_white_color td_center td_accent_bg">50+</p>
                            <h3 class="td_fs_14 td_semibold mb-0">We Have Best Winning Awards</h3>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.35s">
                <div class="td_section_heading td_style_1 td_mb_40">
                    ...
                    <h2 class="td_section_title td_fs_48 td_mb_24">Experience Over 10 years with Online Educations
                    </h2>
                ...
                <div class="td_mb_40 position-relative">
                    <ul class="td_list td_style_2 td_fs_24 td_medium td_heading_color td_mp_0">
                        <li>
                            <svg class="td_heading_color" width="26" height="24" viewBox="0 0 26 24"
                    ...
                    <div class="td_list_2_shape">
                        <svg width="220" height="209" viewBox="0 0 220 209" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
